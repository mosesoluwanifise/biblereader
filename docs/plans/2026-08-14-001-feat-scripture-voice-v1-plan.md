...
- **Open RAIL-M obligations are contractual, not advisory.** Distribution triggers license pass-through, license delivery, and change notices. *Mitigation: U5 covers the engineering surface; the terms language in `docs/TERMS.md` should have legal review before any paid launch.*
